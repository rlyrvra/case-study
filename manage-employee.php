...
<head>
<title> Manage Employees | smartWage </title>
<!-- font-awesome -->
...
<!-- Ajax -->
<script src="employees/modules/manage-employee-ajax.js?v1.5"></script>
<!-- Scripts -->
<script src="employees/modules/manage-employee-skeleton.js?v1.2"></script>
<script src="employees/modules/manage-employee-scripts.js?v1.5"></script>
    ...
    <?php require_once __DIR__ . '/user.php' ?>
      ...
      <div class="content-wrapper">
        <div class="container-fluid pt-5 pb-5">
          ...
          <div class="card py-4 row mx-auto text-no-wrap">
