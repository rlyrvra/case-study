<div class="controls d-flex justify-content-between flex-column flex-lg-row"> 
    ...
    <div class="col-auto d-flex align-items-center mx-1">
        <div class="btn-group">
            <input class="btn-check" type="radio" name="view" id="table-view" value="table" checked onchange="fetchAllHolidays()">
            <label class="btn btn-outline-primary" for="table-view">
                <i class="bx bx-table"></i>
            </label>

            <input class="btn-check" type="radio" name="view" id="card-view" value="card" onchange="fetchAllHolidays()">
    ...
    <div class="col-auto d-flex align-items-center mx-1">
        ...
        <div class="ddropdown sort mx-1">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="dropdownMenuButton">
                ...
                <li><a class="dropdown-item" href="#" data-group="sort_by" data-value="start_date">Start Date</a></li>
                <li><hr/></li>
   ...
   <div class="align mx-1 d-flex align-items-center"> 
        ...
        <select class="form-select" id="entries-per-page" onchange="fetchAllHolidays()">
    ...
    <div class="search col-auto flex-fill col-auto mx-1">
        ...
        <span class="input-group-text"><i class="bx bx-search-alt-2 fs-4 lh-0"></i></span>
            ...
            <button id="openModalBtn" class="btn btn-success" onclick="fetchAllHolidays()"> Search
            </button>
        </div>  
    </div>
</div>
