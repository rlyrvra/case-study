        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form onsubmit="event.preventDefault();" id="create_job_title_form">
                    <!-- Job Title -->
                    <div class="mb-3">
                        <label for="create_jobtitle_title" class="form-label">
                    ...
                    <!-- Department Name -->
                    <div class="mb-3">
                        <label for="create_jobtitle_department_name" class="form-label">
                    ...
                    <!-- Job Status -->
                    <div class="mb-3">
                        <label for="create_jobtitle_status" class="form-label">
                            Status <span class="label-danger">(*)</span>
                        </label>
                        <select class="form-select" id="create_jobtitle_status" name="create_jobtitle_status" required>
