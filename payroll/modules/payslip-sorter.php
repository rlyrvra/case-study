<div class="controls d-flex justify-content-between align-content-center flex-column flex-lg-row"> 
    ...
    <div class="align mx-1 d-flex align-items-center"> 
        ...
        <select class="form-select" id="entries-per-page" onchange="fetchAllPayslips()">
    ...
    <div class="dropdown filter flex-fill col-auto  mx-1">
        <div class="input-group">
            ...
            <select class="form-select selectize-employee-sorter" id="selectize_employee_sorter" name="selectize-employee-sorter" placeholder="Filter Employee" onchange="fetchAllPayslips();">
