<div class="controls d-flex justify-content-between flex-column flex-lg-row"> 
    ...
    <div class="col-auto d-flex align-items-center mx-1">
        <div class="btn-group">
            <input class="btn-check" type="radio" name="view" id="table-view" value="table" checked onchange="fetchAllPayrollGroups()">
            <label class="btn btn-outline-primary" for="table-view">
                <i class="bx bx-table"></i>
            </label>

            <input class="btn-check" type="radio" name="view" id="card-view" value="card" onchange="fetchAllPayrollGroups()">
 ...
 <div class="align mx-1 d-flex align-items-center"> 
    ...
    <div class="dropdown filter flex-fill col-auto  mx-1">
        <div class="input-group">
            ...
            <select class="form-select" id="status" name="status" placeholder="Filter By Status" onchange="fetchAllPayrollGroups()">
