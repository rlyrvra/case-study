...
class Employee
{
    public function __construct(
        ...
        private readonly ?string $emergency_contact_email_address,
        private readonly ?string $emergency_contact_address      ,
