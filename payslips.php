...
<head>
<title> Payslips | smartWage </title>
...
<div class="layout-wrapper layout-content-navbar">
  <div class="layout-container">
    ...
    <script>
      ...
      document.getElementById("payslip-menu").classList.add("active");
    </script>
      ...
      <div class="content-wrapper">
        <div class="container-fluid pt-5 pb-5">
            ...
            <div class="container-fluid mb-3 d-flex justify-content-between flex-column flex-lg-row">
                <h1 class="display-1">Payslips</h1>
            </div>
...
<!-- / Layout wrapper -->
<?php require_once __DIR__ . '/payroll/modules/payslip-fetch-employees.php' ?>
<script>
