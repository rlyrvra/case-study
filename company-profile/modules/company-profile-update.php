...
<div id="company-profile-section" class="container my-5 p-5 card">
  ...
  <div class="row align-items-center header">
    <div class="col-md-6">
      <input class="form-control" list="datalistOptions" id="company_name" placeholder="Enter Company Name..." style="min-height: 75px; font-size: 2.0rem;" value="<?php echo htmlspecialchars($companyProfile[0]['name']); ?>"/>
      ...
      <input id="date_established" class="form-control form-control-sm mt-2" type="date" value="<?php echo htmlspecialchars($companyProfile[0]['date_established']); ?>" />
    </div>
    <div class="col-md-6 text-center">
      ...
      ?>
      <img src="<?php echo htmlspecialchars($relativePath); ?>" id="company_picture" class="w-px-100 h-auto rounded-circle">
      <div class="text-box mx-auto" style="max-height: 100px; max-width: 300px;">
        <input type="file" class="form-control" id="company_picture_file" accept="image/*" onchange="previewImage(event)">
      </div>
    </div>
  </div>
  <!-- Search Button -->
      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="companyHistory">
          ...
          <script>
            ...
            $(document).ready(function(){
              historySimpleMde.value('<?php echo htmlspecialchars($companyProfile[0]['history']); ?>');
            });
        ...
        <div class="tab-pane fade" id="companyDetails">
          <div class="input-group">
            ...
            <input type="text" id="industry" class="form-control" placeholder="Enter Industry" value="<?php echo htmlspecialchars($companyProfile[0]['industry']); ?>"/>
          </div>
          ...
          <div class="input-group mt-2">
            ...
            <input type="text" id="business_type" class="form-control" placeholder="Enter Business Type" value="<?php echo htmlspecialchars($companyProfile[0]['business_type']); ?>" />
          </div>
          ...
          <div class="input-group mt-2">
            ...
            <input type="text" id="company_size" class="form-control" placeholder="Size Of Company" value="<?php echo htmlspecialchars($companyProfile[0]['size']); ?>" />
          </div>
          ...
          <div class="input-group mt-2">
            ...
            <input type="text" id="employee_count" class="form-control" placeholder="Enter Employee Count" value="<?php echo htmlspecialchars($companyProfile[0]['employee_count']); ?>" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="address">
          <div class="input-group">
            ...
            <input type="text" id="addressInput" class="form-control" placeholder="Address" value="<?php echo htmlspecialchars($companyProfile[0]['address']); ?>" />
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="phone">
          <div class="input-group">
            ...
            <input type="text" id="phoneInput" class="form-control" placeholder="Phone Number" value="<?php echo htmlspecialchars($companyProfile[0]['phone']); ?>" />
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="email">
          <div class="input-group">
            ...
            <input type="email" id="emailInput" class="form-control" placeholder="Enter your email..." aria-describedby="emailHelp" value="<?php echo htmlspecialchars($companyProfile[0]['email']); ?>"/>
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="website">
          <div class="input-group">
            ...
            <input type="text" id="websiteInput" class="form-control" placeholder="Website" value="<?php echo htmlspecialchars($companyProfile[0]['website']); ?>"/>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="tab-pane fade show active" id="mission">
          <div class="header-inputs">
            ...
            <script>
              ...
              $(document).ready(function(){
                missionSimplemde.value('<?php echo htmlspecialchars($companyProfile[0]['mission']); ?>');
              });
        ...
        <div class="tab-pane fade" id="vision">
          <div class="header-inputs">
            ...
            <script>
              ...
              $(document).ready(function(){
                visionSimpleMde.value('<?php echo htmlspecialchars($companyProfile[0]['vision']); ?>');
              });
        ...
        <div class="tab-pane fade" id="values">
          <div class="header-inputs">
            ...
            <script>
              ...
              $(document).ready(function(){
                valuesSimpleMde.value('<?php echo htmlspecialchars($companyProfile[0]['company_values']); ?>');
              });
        ...
        <div class="tab-pane fade show active" id="complianceHistory">
          <div class="header-inputs">
            ...
            <script>
              ...
              $(document).ready(function(){
                policiesSimpleMde.value('<?php echo htmlspecialchars($companyProfile[0]['policies']); ?>');
              });
        ...
        <div class="tab-pane fade" id="complianceDetails">
          <div class="header-inputs">
            ...
            <script>
              ...
              $(document).ready(function(){
                complianceSimpleMde.value('<?php echo htmlspecialchars($companyProfile[0]['compliance']); ?>');
              });
        ...
        <div class="tab-pane fade" id="complianceNotes">
          <div class="header-inputs">
            ...
            <script>
              ...
              $(document).ready(function(){
                importantNotesSimpleMde.value('<?php echo htmlspecialchars($companyProfile[0]['notes']); ?>');
              });
