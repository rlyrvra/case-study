...
<div class="modal fade" id="update-deductions-modal" tabindex="-1" aria-labelledby="update-deductions-modalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content shadow-sm border-0">
            <div class="modal-header bg-light border-bottom">
                <h2 class="modal-title fs-5 fw-semibold text-primary" id="update-deductions-modalTitle">
                    <i class="bx bx-minus"></i> Update Deduction
                </h2>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
                <form id="update_deductions_form" onsubmit="event.preventDefault();">
                    <div class="row g-3">
                        <!-- Name -->
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control shadow-sm" id="update_name" name="update_name"
                                ...
                                placeholder="Ex. Sample Deduction"
                ...
                <div class="modal-footer border-top bg-light">
                    ...
                    <button type="submit" id="update_deduction_btn" class="btn btn-info" onclick="updateDeductions(this);">
