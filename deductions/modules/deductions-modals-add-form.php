...
<!-- Deductions Add Form Modal -->
<div class="modal fade" id="add-deductions-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content shadow-sm border-0">
            <div class="modal-header bg-light border-bottom">
                <h2 class="modal-title fs-5 fw-semibold text-success" id="add-deductions-modalTitle">
                    <i class="bx bx-minus"></i> Create Deduction
                </h2>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            
            <div class="modal-body">
                <form id="add_deductions_form" onsubmit="event.preventDefault();">
                    <div class="row g-3">
                        <!-- Name -->
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control shadow-sm" id="create_name" name="create_name"
                                required placeholder="Sample Deduction" minlength="3" maxlength="50"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control shadow-sm" id="create_amount" name="create_amount"
                                required placeholder="100" min="1" step="1">
                        </div>
                    </div>
            ...
            <div class="modal-footer border-top bg-light">
                ...
                <button type="submit" class="btn btn-success" onclick="createDeductions();">
