<div class="controls d-flex justify-content-between flex-column flex-lg-row"> 
    ...
    <div class="col-auto d-flex align-items-center mx-1">
        <div class="btn-group">
            <input class="btn-check" type="radio" name="view" id="table-view" value="table" checked onchange="fetchAllDeductions()">
            <label class="btn btn-outline-primary" for="table-view">
                <i class="bx bx-table"></i>
            </label>

            <input class="btn-check" type="radio" name="view" id="card-view" value="card" onchange="fetchAllDeductions()">
    ...
    <div class="align mx-1 d-flex align-items-center"> 
        ...
        <select class="form-select" id="entries-per-page" onchange="fetchAllDeductions()">
    ...
    <div class="dropdown filter flex-fill col-auto  mx-1">
        <div class="input-group">
            ...
            <select class="form-select" id="status" name="status" placeholder="Filter By Status" onchange="fetchAllDeductions()">
