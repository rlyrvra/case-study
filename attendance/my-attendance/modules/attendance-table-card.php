    ...
    <?php if (!empty($myAttendance)): ?>
      <?php $i = ($offset + 1); foreach ($myAttendance as $row): ?>
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="card shadow-sm border-1 overflow-hidden transition-card">
            ...
            <div class="card-body p-4">
              <div class="d-flex justify-content-between">
                <div>
                  <h5 class="mb-0"><?php echo htmlspecialchars(date("F j, Y", strtotime($row['date']))); ?></span></h5>
                  <small><?php echo htmlspecialchars(date("l", strtotime($row['date']))); ?></small>
                </div>
