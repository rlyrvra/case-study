                                    ...
                                    if ($startMinutes > 0) {
                                        ...
                                        if ($isNightShift) {
                                            if (($hoursWorked > $totalRequiredHours && ( ! $workSchedule['is_flextime'])) ||
                                                ($holidayType !== 'non_holiday' && $hoursWorked > 8 && ( ! $workSchedule['is_flextime']))) {
                                        ...
                                        foreach ($defaultBreaks as $break) {
                                            if ( ! $break['is_paid']) {
                                                ...
                                                if ($breakStartTime->format('Y-m-d H') === $breakEndTime->format('Y-m-d H')) {
                                                    ...
                                                    if ($isNightShift) {
                                                        if (($holidayType !== 'non_holiday' && $hoursWorked > 8 && ( ! $workSchedule['is_flextime']))) {
                                                            $hourSummary[$dayType][$holidayType]['night_differential_overtime'] -= $breakDuration / 60;
                                                        } else {
                                                            $hourSummary[$dayType][$holidayType]['night_differential'] -= $breakDuration / 60;
                                                        }
                                                    } else {
                                                        if (($holidayType !== 'non_holiday' && $hoursWorked > 8 && ( ! $workSchedule['is_flextime']))) {
                                                            $hourSummary[$dayType][$holidayType]['overtime_hours'] -= $breakDuration / 60;
                                                        } else {
