...
<div class="container">
  <div class="row">
    <?php $i = ($offset + 1); if (!empty($allowances)): ?>
      <?php foreach ($allowances as $row): ?>
        <div class="col-md-6 col-lg-4">
          <div class="card shadow-sm mb-4 transition-card border-1" onclick="clickCardEvent(this, event);">
            ...
            <div class="card-body">
              <p class="card-text"><strong>Description:</strong> <?= highlightText($row['description'], $searchFilter); ?></p>
                      ...
                      >
                        <td colspan="2">
                          <div class="d-flex justify-content-between">
                            <button class="btn btn-sm btn-info" title="Edit" onclick="updateAllowanceClick(this)" data-bs-toggle="modal" data-bs-target="#update_allowances_modal"> 
                              <i class="bx bx-edit-alt"></i> Edit
                            </button>
                            <button class="btn btn-sm btn-danger" title="Delete" onclick="confirmDeleteAllowance(this)"> 
