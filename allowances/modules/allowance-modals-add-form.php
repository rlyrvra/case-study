    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="add-allowances-modalTitle">Allowance Form</h2>
                <button
                    type="button"
                    class="btn-close"
            ...
            <form onsubmit='event.preventDefault()' id="add_allowance_form">
                <!-- Name -->
                <div class="form-group mb-3">
                    <label for="create_name">Name*:</label>
                    <input type="text" class="form-control" id="create_name" name="create_name" maxlength="50" placeholder="Ex. Sample Allowance" required>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" onclick="createAllowance();"><i class="bx bx-plus bx-xs"></i>Create</button>
            </div>
