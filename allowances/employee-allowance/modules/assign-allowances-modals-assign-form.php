...
<!-- Assign Allowances Form Modal -->
<div class="modal fade" id="assign_allowances_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
        <div class="modal-content shadow-sm border-0">
            <div class="modal-header bg-light border-bottom">
                <h2 class="modal-title fs-5 fw-semibold text-success" id="assign_allowances_modalTitle">
                    <i class="bx bx-wallet"></i> Assign Allowances
                </h2>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            
            <div class="modal-body">
                <form id="allowance_form" onsubmit="event.preventDefault()">
                    <div class="row mb-4">
                        <label for="select_employee" class="form-label fw-semibold">Employee <span class="text-danger">*</span></label>
                        <select class="form-select selectize_select_employee shadow-sm" id="select_employee" name="select_Employee" required onchange="fetchEmployeeAllowances();">
                        </select>
                    </div>
                    ...
                    <div class="row mb-4 justify-content-center">
                        <button type="submit" class="btn-lg btn-info col-auto mx-auto" onclick="assignAllowanceName()">
                            <i class="bx bx-label bx-sm"></i> Assign Allowances
                        </button>
                        <button type="button" class="btn-lg btn-primary col-auto mx-auto" onclick="fetchEmployeeAllowances()">
