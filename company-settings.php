...
<head>
  ...
  <head>
    <title> smartWage | Company Settings </title>
  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      ...
      <script>
        ...
        document.getElementById("company-settings-menu").classList.add("active");
      </script>
        ...
        <div class="content-wrapper">
          <div class="container-fluid pt-5 pb-5">
            <div class="container-fluid mb-3 d-flex justify-content-between flex-column flex-lg-row">
              <h1 class="display-1">Company Settings</h1>
            </div>

            <div class="container-fluid card pt-5 pb-3 mt-5">
              <div class="card-header">
                <h5>List of Company Settings
              </div>
              <div class="card-body">
                <div id="settings-table" class="table-responsive text-no-wrap">
                  <div id="loadingSpinner" class="container-fluid spinner-border spinner-border-lg d-flex align-items-center justify-content-center w-px-700 h-px-700" role="status"></div>
                </div>
              </div>
            </div>
